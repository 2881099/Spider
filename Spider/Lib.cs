...
public class Lib {
	...
	public static string HtmlEncode(object input) { return System.Web.HttpUtility.HtmlEncode(string.Concat(input)); }
	public static string HtmlDecode(object input) { return System.Web.HttpUtility.HtmlDecode(string.Concat(input)); }
	public static string UrlEncode(object input) { return System.Web.HttpUtility.UrlEncode(string.Concat(input)); }
	public static string UrlDecode(object input) { return System.Web.HttpUtility.UrlDecode(string.Concat(input)); }
